 ...
 * 3. window.wxc.xcConfirm("請输入","input",{onOk:function(){}})
...
(function($){
	...
	window.wxc.xcConfirm = function(popHtml, type, options) {
		...
		var itype = type ? type instanceof Object ? type : popType[type] || {} : {};//格式化输入的参數:弹窗類型
		var config = $.extend(true, {
			//属性
			title: "", //自定义的标题
			icon: "", //圖标
			btn: btnType.ok, //按钮,默認單按钮
			//事件
			onOk: $.noop,//點擊确定的按钮回调
			onCancel: $.noop,//點擊取消的按钮回调
